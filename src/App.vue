    ...
    >
      <div v-if="currentFormatErrorDetail">
        <div class="error-detail-header">
          ...
          <div v-if="currentFormatErrorDetail.errors && currentFormatErrorDetail.errors.length > 0" style="margin: 10px 0;">
...
export default {
  ...
  methods: {
    ...
    exportFormatErrorCsv() {
      if (!this.currentFormatErrorDetail || !this.currentFormatErrorDetail.errors || this.currentFormatErrorDetail.errors.length === 0) {

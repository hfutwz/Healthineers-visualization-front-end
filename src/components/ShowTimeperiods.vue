...
export default {
  ...
  data() {
    ...
    return {
      ...
      heatmapData: [
        // 周一至周日，六个时间段的数据
        ['早高峰(7-9)', 12, 15, 8, 10, 7, 9, 11],
        ['上午(10-12)', 9, 11, 7, 8, 6, 10, 12],
        ['午高峰(11-13)', 15, 18, 12, 14, 16, 20, 22],
        ['下午(14-17)', 10, 12, 9, 11, 8, 13, 10],
        ['晚高峰(17-19)', 18, 20, 15, 17, 19, 25, 23],
        ['夜间(20-6)', 8, 10, 6, 7, 9, 15, 14]
      ],
      totalPatients: 0,
      peakTime: '',
      peakDay: '',
      ...
      const option = {
        tooltip: {
          ...
          formatter: function (params) {
            ...
            const times = ['早高峰(7-9)', '上午(10-12)', '午高峰(11-13)', '下午(14-17)', '晚高峰(17-19)', '夜间(20-6)'];
        ...
        yAxis: {
          type: 'category',
          data: ['早高峰(7-9)', '上午(10-12)', '午高峰(11-13)', '下午(14-17)', '晚高峰(17-19)', '夜间(20-6)'],
          splitArea: {
            show: true
          },
          axisLabel: {

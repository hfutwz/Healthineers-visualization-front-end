<template>
  <div class="patient-list-page">
    ...
    <!-- 删除确认对话框 -->
    <div v-if="showDeleteDialog" class="modal-overlay delete-modal-overlay" @click="closeDeleteDialog">
      <div class="modal-content delete-dialog" @click.stop>
        <div class="delete-dialog-header">
          ...
          <h3 class="delete-dialog-title">确认删除</h3>
          <button @click="closeDeleteDialog" class="close-btn" :disabled="isDeleting">&times;</button>
        </div>
